...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.D:\windows\programs\xamp\htdocs\world\public\storage' => 'string',
...
'app.aliases.Vite','app.currency','auth.defaults.guard','auth.defaults.passwords','auth.guards.web.driver',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.D:\\windows\\programs\\xamp\\htdocs\\world\\public\\storage','logging.default','logging.deprecations.channel',
...
'mail.from.name','mail.markdown.theme','mail.markdown.paths','money.locale','money.defaultCurrency',
'money.defaultFormatter','money.defaultSerializer','money.isoCurrenciesPath','money.currencies.iso','money.currencies.bitcoin',
'money.currencies.custom','queue.default','queue.connections.sync.driver','queue.connections.database.driver','queue.connections.database.connection',
...
'dashboard','home','layouts.app','layouts.guest','livewire.layout.navigation',
...
'livewire.pages.auth.verify-email','livewire.profile.delete-user-form','livewire.profile.update-password-form','livewire.profile.update-profile-information-form','livewire.welcome.navigation',
'products.show','profile','volt-livewire::layout.navigation','volt-livewire::pages.auth.confirm-password','volt-livewire::pages.auth.forgot-password',
'volt-livewire::pages.auth.login','volt-livewire::pages.auth.register','volt-livewire::pages.auth.reset-password','volt-livewire::pages.auth.verify-email','volt-livewire::profile.delete-user-form',
'volt-livewire::profile.update-password-form','volt-livewire::profile.update-profile-information-form','volt-livewire::welcome.navigation','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
